...
def main() -> None:
    ...
    parser.add_argument('--state-file', type=Path, default=Path('state.kore'), help='State file path (default: state.kore)')
    parser.add_argument('--trace', action='store_true', default=False, help='Enable instruction-level execution tracing')
